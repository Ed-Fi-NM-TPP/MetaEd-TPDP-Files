...
BEGIN TRANSACTION
GO
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'edfi.ValueType') AND name = N'UX_ValueType_Id')
CREATE UNIQUE NONCLUSTERED INDEX UX_ValueType_Id ON edfi.ValueType
(Id) WITH( PAD_INDEX = ON, FILLFACTOR = 100, STATISTICS_NORECOMPUTE = OFF) ON [PRIMARY]
GO
COMMIT
